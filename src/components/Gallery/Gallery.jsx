...
const Gallery = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Event Gallery | EventGlow - Our Portfolio of Memorable Events</title>
        <meta 
          name="description" 
          content="Browse our stunning event gallery showcasing concerts, weddings, corporate events and more. See how EventGlow creates unforgettable experiences." 
        />
        <meta 
          name="keywords" 
          content="event gallery, event photos, concert photography, wedding events, corporate events, party planning" 
        />
        <meta property="og:title" content="Event Gallery | EventGlow" />
        <meta property="og:description" content="View our portfolio of beautifully executed events across various categories." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://eventglow.com/gallery" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1492684223066-81342ee5ff30?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" />
      </Helmet>
      ...
      <div className="relative h-96 w-full overflow-hidden">
        <img
          ...
          alt="EventGlow Gallery Showcase"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredImages.map((image, index) => (
              ...
              >
                ...
                <img
                  src={image.url}
                  alt={`${image.title} - ${image.category} event by EventGlow`}
            ...
            <div className="relative max-w-5xl w-full max-h-screen">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 mt-2">Event organized by EventGlow</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
