...
import { FaUsers, FaTrophy, FaCalendarCheck, FaLightbulb } from "react-icons/fa";
...
const About = () => {
  ...
  return (
    <section id="about" className="relative py-20 overflow-hidden bg-gradient-to-b from-gray-900 to-black">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            We illuminate events with creativity, passion, and precision to create unforgettable experiences.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <h3 className="text-3xl font-bold text-white">
              Creating <span className="text-purple-400">Magical Moments</span> Since 2015
            </h3>
            <p className="text-gray-400">
              Founded in a small studio with big dreams, EventGlow has grown into a premier event management company known for its innovative approach and attention to detail. What started as a passion project between friends has blossomed into a full-service event production powerhouse.
            </p>
            <p className="text-gray-400">
              We believe every event should tell a story - your story. Our team of creative professionals works tirelessly to ensure your vision comes to life in the most spectacular way possible, leaving your guests with memories that shine bright long after the event ends.
            </p>
            <div className="relative group">
            ...
            <div className="relative bg-gray-800 rounded-2xl overflow-hidden h-96">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-6">
                  ...
                  <h4 className="text-2xl font-bold text-white mb-2">Our First Event</h4>
                  <p className="text-gray-300">A simple birthday party that started it all</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="text-center mb-12">
          ...
          >
            Meet <span className="text-purple-400">The Team</span> Behind the Magic
          </motion.h3>
          <motion.p
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          >
            Our talented team of event specialists brings creativity, expertise, and passion to every project.
          </motion.p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Creativity",
                description: "We believe in thinking outside the box to deliver unique experiences that stand out.",
                icon: <FaLightbulb className="text-4xl text-purple-400" />
              },
              {
                title: "Excellence",
                description: "Every detail matters. We strive for perfection in all aspects of our work.",
                icon: <FaTrophy className="text-4xl text-pink-400" />
              },
              {
                title: "Passion",
                description: "Our love for what we do shines through in every event we create.",
