...
const About = () => {
  ...
  const floatingElements = [
    {
      icon: <GiPartyFlags className="text-2xl md:text-3xl text-purple-400" />,
    ...
    {
      icon: <GiSparkles className="text-2xl md:text-3xl text-pink-400" />,
    ...
    {
      icon: <MdOutlineEmojiPeople className="text-2xl md:text-3xl text-blue-400" />,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center mb-16 md:mb-20">
          ...
          >
            ...
            <video
              ...
              poster="/event-poster.jpg" // Replace with your poster image path
            >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center p-4 md:p-6">
                <GiSparkles className="text-4xl md:text-5xl lg:text-6xl text-yellow-400 mx-auto mb-2 md:mb-4" />
                ...
                <div className="relative bg-gray-900 rounded-2xl overflow-hidden border border-gray-800">
                  ...
                  <div className="p-4 md:p-6">
                    ...
                    <div className="mt-3 md:mt-4 flex justify-center space-x-3 md:space-x-4">
                      <button className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-purple-600 transition-colors">
                      ...
                      <button className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-600 transition-colors">
                      ...
                      <button className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-pink-600 transition-colors">
            ...
            {[
              {
                ...
                icon: <FaLightbulb className="text-3xl md:text-4xl text-purple-400" />,
              },
              {
                title: "Excellence",
                description:
                  "Every detail matters. We strive for perfection in all aspects of our work.",
                icon: <FaTrophy className="text-3xl md:text-4xl text-pink-400" />,
              },
              {
                title: "Passion",
                description:
                  "Our love for what we do shines through in every event we create.",
                icon: <GiSparkles className="text-3xl md:text-4xl text-blue-400" />,
              },
            ].map((value, index) => (
              <motion.div
                key={index}
