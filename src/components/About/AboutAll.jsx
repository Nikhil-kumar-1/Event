...
import { FaUsers, FaTrophy, FaCalendarCheck, FaLightbulb, FaQuoteLeft } from "react-icons/fa";
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Discover the passion, people, and purpose behind EventGlow's success in creating unforgettable experiences.
          </p>
        </motion.div>
