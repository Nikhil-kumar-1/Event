...
const AboutAll = () => {
  ...
  const teamMembers = [
    {
      image: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZXZlbnR8ZW58MHx8MHx8fDA%3D",
      name: "Alex Johnson",
      role: "Founder & CEO",
      social: {
        twitter: "#",
  ...
  return (
    <>
      <Helmet>
        <title>About Us - EventGlow | Our Story & Team</title>
        <meta 
          name="description" 
          content="Discover EventGlow's journey, meet our passionate team, and learn about our commitment to creating unforgettable event experiences." 
        />
        <meta 
          name="keywords" 
          content="event planning, about us, event company, our team, event management" 
        />
        <meta property="og:title" content="About EventGlow - Our Story & Team" />
        <meta property="og:description" content="Learn about EventGlow's journey and meet the creative minds behind our successful events." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://eventglow.com/about" />
      </Helmet>
        ...
        <div className="absolute inset-0 bg-black opacity-80 flex items-center justify-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
              Our <span className="text-purple-400">Story</span> & <span className="text-pink-400">Team</span>
            </h1>
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              Discover the passion and people behind EventGlow's unforgettable experiences
            </p>
          </motion.div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gray-900 rounded-2xl overflow-hidden border border-gray-800">
                  <img 
                    ...
                    alt="Alex Johnson - Founder & CEO of EventGlow"
                    className="w-full h-full object-cover"
                  />
                </div>
              </div>
            ...
            >
              <h2 className="text-3xl font-bold text-white">
                Meet <span className="text-purple-400">Alex Johnson</span>, Our Founder
              </h2>
              <div className="relative">
                <FaQuoteLeft className="text-4xl text-gray-700 absolute -top-2 -left-2" />
                <p className="text-lg text-gray-400 pl-10">
                  "I started EventGlow with a simple vision: to create events that don't just happen, but truly shine. What began as a passion project has grown into a family of creative professionals who share this vision."
                </p>
              </div>
              <p className="text-gray-400">
                With over 15 years in the event industry, Alex's expertise and innovative approach have shaped EventGlow's reputation for excellence. His leadership continues to inspire our team to push creative boundaries.
              </p>
            ...
            <div className="relative">
              ...
              <div className="space-y-12">
                {timeline.map((item, index) => (
                  ...
                  >
                    <div className={`flex-shrink-0 w-1/2 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8'}`}>
                    ...
                    <div className={`flex-shrink-0 w-1/2 ${index % 2 === 0 ? 'pl-8' : 'pr-8 text-right'}`}>
          ...
          <div className="mb-20">
            ...
            >
              <h3 className="text-3xl font-bold text-white mb-4">
                The <span className="text-purple-400">Creative Minds</span> Behind Your Events
              </h3>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Our team of passionate professionals brings diverse expertise to create your perfect event.
              </p>
            </motion.div>
                ...
                >
                  ...
                  <div className="relative bg-gray-900 rounded-2xl overflow-hidden border border-gray-800">
                    <div className="h-80 overflow-hidden">
                      <img 
                        src={member.image} 
                        alt={`${member.name} - ${member.role} at EventGlow`}
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex justify-center space-x-4">
                        <a href={member.social.twitter} className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-400 transition-colors">
                          <span className="sr-only">Twitter</span>
                          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                          </svg>
                        </a>
                        <a href={member.social.linkedin} className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-600 transition-colors">
                          <span className="sr-only">LinkedIn</span>
                          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                          </svg>
                        </a>
                        <a href={member.social.instagram} className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-pink-600 transition-colors">
          ...
          >
            <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 rounded-2xl border border-gray-800 p-8 md:p-12">
              ...
              <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto text-center">
                Our team is excited to bring your vision to life with creativity and precision.
              </p>
