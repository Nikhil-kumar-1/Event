      ...
      <div className="min-h-screen bg-gray-900 text-white">
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-20 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            >
              <Link to="/book-event">
                <button className="w-full px-6 py-3 md:px-8 md:py-3 bg-gradient-to-r from-amber-500 to-yellow-500 text-black rounded-full font-medium text-base md:text-lg shadow-lg hover:shadow-yellow-400/50 transition-all duration-300 flex items-center justify-center gap-2">
                  Plan Your Event
                </button>
              </Link>
              <Link to="/reels">
              ...
              >
                <div className="relative h-64">
                  <video autoPlay loop muted playsInline className="w-full h-full object-cover">
                    <source
                      src={
                        item === 1
                          ? "https://cdn.pixabay.com/video/2023/08/11/175579-853849692_tiny.mp4"
                          : item === 2
                ...
                <div className="p-6">
                  <p className="text-gray-300 mb-4">
                    {item === 1
                      ? "An elegant evening celebrating corporate achievements with 500+ guests."
                      : item === 2
                      ? "Three-day outdoor music festival featuring top international artists."
                      : "Breathtaking beach wedding ceremony with custom-designed decor."}
                  </p>
                  <Link to="/case-study">
                    <button className="text-amber-400 hover:text-yellow-300 font-medium flex items-center gap-2">
        ...
        {/* Stats Section */}
        <section className="py-20 bg-gradient-to-r from-yellow-800 to-amber-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <motion.div
                ...
                className="p-6"
              >
                <div className="text-4xl md:text-5xl font-bold mb-2 text-amber-300">250+</div>
                <div className="text-gray-300 flex items-center justify-center gap-2">
                  <FaUsers className="text-yellow-300" /> Events
                </div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                ...
                className="p-6"
              >
                <div className="text-4xl md:text-5xl font-bold mb-2 text-amber-300">15K+</div>
              ...
              <motion.div
                ...
                className="p-6"
              >
                <div className="text-4xl md:text-5xl font-bold mb-2 text-amber-300">50+</div>
              ...
              <motion.div
                ...
                className="p-6"
              >
                <div className="text-4xl md:text-5xl font-bold mb-2 text-amber-300">100%</div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="bg-gray-800 rounded-2xl p-8 md:p-12 text-center">
            ...
            <Link to="/book-event">
              <button className="px-8 py-4 bg-gradient-to-r from-amber-500 to-yellow-500 rounded-lg font-medium hover:opacity-90 transition-opacity text-lg text-black">
                Get Started Today
              </button>
            </Link>
          </div>
